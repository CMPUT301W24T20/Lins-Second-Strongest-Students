...
/**
 * Test class for removing an event as an admin in EventDetailsAdminActivity.
 */
@RunWith(AndroidJUnit4.class)
public class RemoveEventAdminTest {
    /**
    ...
    /**
     * Tests the removal of an event by an admin and verifies that the event is deleted from the database
     * and from all users' eventsAttended lists.
     */

    @Test
    public void RemoveAdminEventTest() {



        try (ActivityScenario<EventDetailsAdminActivity> scenario = ActivityScenario.launch(EventDetailsAdminActivity.class)) {
